template<int HASH_COUNT>
struct RollingHash {
	
	static const int MAX_HASH_PAIRS = 10;

	// {mul, mod}
	const vector<pair<int, int>> HASH_PAIRS = {{827167801, 999999937}, {998244353, 999999929}, {146672737, 922722049}, {204924373, 952311013}, {585761567, 955873937}, {484547929, 901981687}, {856009481, 987877511}, {852853249, 996724213}, {937381759, 994523539}, {116508269, 993179543}};
	
	int n;
	vector<int> POW[MAX_HASH_PAIRS];
